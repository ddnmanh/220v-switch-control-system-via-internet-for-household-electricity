...
import { protobufPackage } from './proto/house.pb';
    ...
    const app: INestMicroservice = await NestFactory.createMicroservice(AppModule, {
        ...
        options: {
            ...
            credentials: grpc.ServerCredentials.createSsl(
                ...
                [{
                    cert_chain: fs.readFileSync(join(__dirname, '../mTLS/houseService.crt')), // Chứng chỉ server
                    private_key: fs.readFileSync(join(__dirname, '../mTLS/houseService.key'))  // Private key server
                }],
