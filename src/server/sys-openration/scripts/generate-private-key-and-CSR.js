...
// Lệnh OpenSSL
const command = `openssl req -new -nodes -newkey rsa:2048 -keyout ${path.join(mtlsDir, 'SysOpenration.key')} -out ${path.join(mtlsDir, 'SysOpenration.csr')} -subj "/C=${country}/ST=${state}/L=${city}/O=${organization}/CN=${domain}"`;
