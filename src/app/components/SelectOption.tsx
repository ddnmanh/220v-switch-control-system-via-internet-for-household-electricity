...
const SelectOptionCPN: React.FC<SelectOptionCPNProps> = ({ label, caption, options, value, onChange, errorMessage = false, ...props }) => {
            ...
            <View style={{width: '100%', flexDirection: 'column', alignItems: 'stretch', justifyContent: 'flex-start', rowGap: 2}}>
                ...
                >
                    <Text style={styles.selectedValue}>{
                        // caption ? caption : `Chọn ${label}`
                        options.find(option => option.value === value)?.label || (caption ? caption : `Chọn ${label}`)
                    }</Text>
...

                {
                    ...
                    && (
                        ...
                        <View style={styles.dropdown}>
                            ...
                            >
                                <Text style={{textAlign: "center"}}>Không có dữ liệu để chọn</Text>
                            </View>
                        </View>
                    )
                }
