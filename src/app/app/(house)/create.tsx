...
const CreateHouseScreen = () => {
    ...
    const [isMainHouse, setIsMainHouse] = React.useState(false);
    ...
    const handleCreateHouse = async () => {
        ...
        try {
            let response = await HouseFetch.create({
                name: inputHouseName,
                description: inputHouseDesc,
            ...
            if (response.status === 200 || response.status === 201) {
                ...
                navigation.reset({
                    index: 0,
                    routes: [ { name: "(main)" as never, params: { screen: "(home)", params: { screen: "indexScreen" }}}]
                });
            }
        } catch (error:any) {
